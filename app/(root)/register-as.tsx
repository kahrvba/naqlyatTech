    ...
    return (
        <View className="flex-1 relative">
            ...
            <SafeAreaView className="flex-1 justify-center items-center">
                <View className="absolute top-[30%] left-[10%]">
                    <Text className="font-bold text-5xl text-center">
                        <Text className="bg-[#EE5316] text-white px-2">Reg</Text>
                        <Text className="text-white">ister as</Text>
                    </Text>
                </View>
                ...
                <View className="absolute top-[60%] w-[80%]">
                    <CustomButton
                        title="Transporter"
                        textVariant="primary"
                        onPress={() => router.push("/(root)/HomeAfterRegistration")}
                    />
                </View>
